...
<div>
  ...
  <?= form_open($mode == 'edit' && isset($item) ? 'management/tariflistrik/update/' . $item->id : 'management/tariflistrik/store', 'class=""my-3"') ?>
  <div class="form-group mb-3">
    ...
    <input class="form-control" placeholder="Masukan Kode Tarif Listrik Baru" type="text" name="kd_tarif" minlength="4"
      maxlength="4" value="<?= $mode == 'edit' && isset($item) ? $item->kd_tarif : '' ?>" <?= $mode == 'show' ? 'disabled' : '' ?>>
  ...
  <div class="form-group mb-3">
    ...
    <input class="form-control" placeholder="Masukan Beban Listrik" type="number" name="beban" min="100"
      value="<?= $mode == 'edit' && isset($item) ? $item->beban : '' ?>" <?= $mode == 'show' ? 'disabled' : '' ?>>
  ...
  <div class="form-group mb-3">
    ...
    <input class="form-control" placeholder="Masukan Tarif Listrik Per Kwh" type="number" name="tarif_perkwh" min="100"
      value="<?= $mode == 'edit' && isset($item) ? $item->tarif_perkwh : '' ?>" <?= $mode == 'show' ? 'disabled' : '' ?>>
