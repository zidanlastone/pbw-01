...
<body>
  ...
  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">
      <span class="fs-4">Stali</span> <br>
      <small class="fs-9">Sistem Informasi Manajemen Tagihan Listrik</small>
    </a>
      ...
      <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary" style="min-height:90vh">
        <div class="offcanvas-lg offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
          ...
          <div class="offcanvas-header">
            <h5 class="offcanvas-title fs-6" id="sidebarMenuLabel">
              <span class="fs-4">Stali</span> <br>
              <small class="fs-9">Sistem Informasi Manajemen Tagihan Listrik</small>
            </h5>
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="<?= base_url('management/tagihan') ?>">
                  <svg class="bi">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="<?= base_url('management/tarif-listrik') ?>">
                  <svg class="bi">
                    <use xlink:href="#cart" />
                  </svg>
                  Tarif Listrik
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="<?= base_url('management/pelanggan') ?>">
                  <svg class="bi">
            ...
            <ul class="nav flex-column mb-auto">
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="<?= base_url('user/profile') ?>">
                  <svg class="bi">
